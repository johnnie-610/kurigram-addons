...
<span class="imp">from</span> pyrogram_patch.patch_helper <span class="imp">import</span> PatchHelper`}
      ...
      <section class="mb-10">
        ...
        <div class="grid sm:grid-cols-2 gap-3 stagger">
          <Feature title="Patching" href="/v0.4/pyrogram-patch/patching" desc="patch() / unpatch() lifecycle and PatchManager configuration" />
          <Feature title="Router" href="/v0.4/pyrogram-patch/router" desc="Hierarchical routers with 25+ event decorators and sub-router nesting" />
          <Feature title="FSM" href="/v0.4/pyrogram-patch/fsm" desc="State machines with state guards, transition validation, and filters" />
          <Feature title="Storage" href="/v0.4/pyrogram-patch/storage" desc="Pluggable backends: Memory, Redis (with circuit breaker), or custom" />
          <Feature title="Middleware" href="/v0.4/pyrogram-patch/middleware" desc="Tri-phase pipeline: before → around → handler → after" />
          <Feature title="Patch Helper" href="/v0.4/pyrogram-patch/patch-helper" desc="Dependency-injected helper with FSM, data access, and snapshots" />
          <Feature title="Circuit Breaker" href="/v0.4/pyrogram-patch/circuit-breaker" desc="Fault tolerance with automatic recovery for storage operations" />
          <Feature title="Configuration" href="/v0.4/pyrogram-patch/configuration" desc="Pydantic settings with environment variable support" />
          <Feature title="Dispatcher" href="/v0.4/pyrogram-patch/dispatcher" desc="PatchedDispatcher internals, middleware chain, and handler DI" />
          <Feature title="Errors" href="/v0.4/pyrogram-patch/errors" desc="15+ structured error types with TraceInfo and JSON serialization" />
        </div>
      </section>
