...
<span class="kw">await</span> message.reply(<span class="str">"Choose:"</span>, reply_markup=kb)`}
      ...
      <section class="mb-10">
        ...
        <div class="grid sm:grid-cols-2 gap-3 stagger">
          <Feature title="Inline Keyboard" href="/pykeyboard/inline-keyboard" desc="Full-featured inline keyboards with callback data, URL buttons, web apps, and more" />
          <Feature title="Reply Keyboard" href="/pykeyboard/reply-keyboard" desc="Reply keyboard markup with contact, location, poll request, and one-time options" />
          <Feature title="Pagination" href="/pykeyboard/pagination" desc="Built-in pagination with duplicate prevention and configurable navigation symbols" />
          <Feature title="Language Selection" href="/pykeyboard/languages" desc="Language picker keyboards with custom locale support" />
          <Feature title="Builder API" href="/pykeyboard/builder" desc="Fluent chainable interface with validation hooks and button transforms" />
          <Feature title="Factory Presets" href="/pykeyboard/factory" desc="One-liner keyboards: confirmation, menu, rating, pagination, and language" />
          <Feature title="Validation & Hooks" href="/pykeyboard/hooks" desc="Button validation rules, keyboard construction hooks, and error handling" />
          <Feature title="Utilities" href="/pykeyboard/utilities" desc="Config-driven keyboard creation, introspection, and validation helpers" />
        </div>
      </section>
