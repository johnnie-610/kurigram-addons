...
def update_readme():
    ...
    pykeyboard_section = create_expandable_section(
        "PyKeyboard", pykeyboard_content
    )
    pyrogram_patch_section = create_expandable_section(
        "Pyrogram Patch", pyrogram_patch_content
    )
...
"""
    ...
    readme_content = re.sub(
        details_pattern, "", readme_content, flags=re.DOTALL
    )
