...
class OnMessage:
    """A class providing decorators for handling messages in Pyrogram.
    
    This class provides the `on_message` decorator which can be used to
    register message handlers in a Pyrogram application.
    """
    ...
    def on_message(
        ...
        Parameters:
            filters: One or more filters to allow only a subset of messages
