...
class FSMConfig(BaseSettings):
    ...
    model_config = ConfigDict(env_prefix="PYROGRAM_PATCH_FSM_")
...
class StorageConfig(BaseSettings):
    ...
    model_config = ConfigDict(env_prefix="PYROGRAM_PATCH_STORAGE_")
...
class MiddlewareConfig(BaseSettings):
    ...
    model_config = ConfigDict(env_prefix="PYROGRAM_PATCH_MIDDLEWARE_")
...
class LoggingConfig(BaseSettings):
    ...
    model_config = ConfigDict(env_prefix="PYROGRAM_PATCH_LOG_")
...
class PyrogramPatchConfig(BaseSettings):
    ...
    model_config = ConfigDict(
        env_prefix="PYROGRAM_PATCH_", case_sensitive=False
    )
...
def print_env_vars() -> None:
    ...
    def print_config_section(section_name: str, section_config: BaseSettings):
        print(f"\n{section_name.upper()}:")
        for field_name, field in section_config.model_fields.items():
            env_name = (
                f"{section_config.model_config.get('env_prefix', '')}{field_name.upper()}"
            )
    ...
    print("\nGeneral:")
    for field_name, field in PyrogramPatchConfig.model_fields.items():
